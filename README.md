...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-c-auth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-c-auth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install aws-c-auth
```
...
It is possible to list all of the versions of `aws-c-auth` available on your platform:
...
```
pixi search aws-c-auth --channel conda-forge
```
